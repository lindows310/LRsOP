...
namespace LAB01
{
    internal class ArrayVector : IVectorable, ICloneable, IComparable<IVectorable>
    {
        private int[] cords;
        public int[] Cords
        {
        ...
        {
            if (this.Length == vector.Length)       return 0;
            else if (this.Length > vector.Length)   return 1;
            else                                    return -1;
        }
        public object Clone()
        {
